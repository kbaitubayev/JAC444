...
System.out.println("\n------->Task 4 ... <-------");
		...
		for (int i = 0; i < numberOfshapes; i++) {
			...
			// in cases that the shape being printed is an object of Circle, Square or Rectangle print their areas
			Shape shape = shapes[i];
			
			if (shape instanceof Circle ) {
				try {
					System.out.printf(" Area = %.4f", ((Circle) shape).calculateArea());					
				} catch (Throwable e) {
				...
				try {
					System.out.printf(" Area = %.4f", ((Square) shape).calculateArea());					
				} catch (Throwable e) {
					System.err.println(e);
				}
			}
				...
				try {
					System.out.printf(" Area = %.4f", ((Rectangle) shape).calculateArea());					
				} catch (Throwable e) {
					System.err.println(e);
				}
			}
